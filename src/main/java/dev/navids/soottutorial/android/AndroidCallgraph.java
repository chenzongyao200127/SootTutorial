...
public class AndroidCallgraph {
    ...
    public static void main(String[] args){
        ...
        boolean drawGraph = args.length > 1 && args[1].equals("draw");
        ...
        // Print some general information of the generated callgraph.
        // Note that although usually the nodes in callgraph
        ...
        for (SootClass sootClass: androidCallGraphFilter.getValidClasses()){
            ...
            for (SootMethod sootMethod : sootClass.getMethods()){
                ...
                System.out.printf("\tMethod %s, #IncomeEdges: %d, #OutgoingEdges: %d%n",
                        sootMethod.getName(),
                        incomingEdge,
                        outgoingEdge);
            }
        ...
        if (reachableParentMapFromEntryPoint.containsKey(unreachableMehthod))
            System.out.println("unreachableMehthod is reachable, a possible path from the entry point: "
                    + getPossiblePath(reachableParentMapFromEntryPoint, unreachableMehthod));
        else
        ...
        if (reachableParentMapFromMainActivity.containsKey(childMethod))
            System.out.println("childMethod is reachable from MainActivity, a possible path: "
                    + getPossiblePath(reachableParentMapFromMainActivity, childMethod));
        else
        ...
        if (reachableParentMapFromMainActivity.containsKey(parentMethod))
            System.out.println("parentMethod is reachable from MainActivity, a possible path: "
                    + getPossiblePath(reachableParentMapFromMainActivity, parentMethod));
        else
